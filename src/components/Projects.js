        	...
        	<div class=" rounded-xl group sm:flex space-x-6 bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
          		...
          		<div class="sm:w-7/12 pl-0 p-5">
            		<div class="space-y-2">
              			...
              			<a href="http://dev-cinqo.gailabs.com/" class="block w-max text-cyan-600">Visit Site</a>
            		</div>
          		</div>
       		</div>
       			<div class="rounded-xl group sm:flex space-x-6 bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
          		...
          		<div class="sm:w-7/12 pl-0 p-5">
            		<div class="space-y-2">
              			...
              			<a href="https://scifi.cprindia.org/" class="block w-max text-cyan-600">Visit Site</a>
            		</div>
          		</div>
       		</div>
       			<div class="rounded-xl group sm:flex space-x-6 bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
          		...
          		<div class="sm:w-7/12 pl-0 p-5">
            		<div class="space-y-2">
              			...
              			<a href="https://cellworks.life/" class="block w-max text-cyan-600">Visit Site</a>
            		</div>
          		</div>
       		</div>
  		</div>
